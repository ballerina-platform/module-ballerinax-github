...
string projectListJson = rootPath + "MilestoneList_data.json";
string projectJson = rootPath + "Milestone_data.json";
...
public function generateRepositoryListData() returns error? {
    ...
    if(response4_1 is github:RepositoryList && response4_2 is github:RepositoryList 
        ...
        string preparedJsonRepoList = "{"+"\"ballerinax/github:"+connecterVersion+":RepositoryOwner\""+":"+arrayOfRepoList+"}";

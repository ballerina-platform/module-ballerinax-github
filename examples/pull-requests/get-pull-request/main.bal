...
public function main() returns error? {
    ...
    // List Pull-Requests of Authenticated User
    github:PullRequestSimple[] prResponses = check github->/repos/[userName]/[userRepoName]/pulls();
    io:println(prResponses.length());
}

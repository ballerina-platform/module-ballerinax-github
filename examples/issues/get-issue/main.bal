...
public function main() {
    ...
    // List issues of Authenticated User
    github:Issue[] issueResponses = check github->/repos/[userName]/[userRepoName]/issues(assignee=userRepoName, labels="bug");
    io:println(issueResponses.length());
}

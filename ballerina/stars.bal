...
isolated function addStar(AddStarInput addStarInput, string accessToken, http:Client 
...
isolated function removeStar(RemoveStarInput removeStarInput, string accessToken, http:Client 
        graphQlClient) returns Error? {

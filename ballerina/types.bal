...
public type SecurityAndAnalysis record {
    ...
    SecurityAndAnalysisSecretScanning secretScanning?;
...
public type NullableRepositoryTemplateRepositoryPermissions record {
    boolean pull?;
    boolean maintain?;
    boolean admin?;
    boolean triage?;
...
public type PullRequestBaseRepoPermissions record {
    boolean pull;
    boolean maintain?;
    boolean admin;
    boolean triage?;
...
public type LicenseContentLinks record {
    string? git;
    string self;
    string? html;
};
...
public type RepositoryAdvisoryIdentifiers record {
...
public type ReposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsOneOf11234 ReposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsOneOf11234Inner[];
...
public type EnvironmentNameVariablesBody record {
...
public type WorkflowRunUsageBillableMACOSJobRuns record {
...
public type RunnerIdLabelsBody3 record {
...
public type RunnerIdLabelsBody2 record {
...
public type FileCommitCommitCommitter record {
    string date?;
    string name?;
    string email?;
};
...
public type MovedColumnInProjectIssueEvent record {
    ...
    string url;
    @jsondata:Name {value: "project_card"}
    MovedColumnInProjectIssueEventProjectCard projectCard?;
    @jsondata:Name {value: "node_id"}
    string nodeId;
};
...
public type MembershipsusernameBody2 record {
    # The role that this user should have in the team
    "member"|"maintainer" role = "member";
};
...
public type ProtectionRulesReviewers record {
...
public type ConvertedNoteToIssueIssueEvent record {
    ...
    string url;
    @jsondata:Name {value: "project_card"}
    ConvertedNoteToIssueIssueEventProjectCard projectCard?;
    @jsondata:Name {value: "node_id"}
    string nodeId;
};
...
public type WorkflowRunUsageBillableWINDOWS record {
    @jsondata:Name {value: "job_runs"}
    WorkflowRunUsageBillableWINDOWSJobRuns[] jobRuns?;
...
public type PullRequestBaseRepo record {
    ...
    @jsondata:Name {value: "subscribers_url"}
    string subscribersUrl;
    PullRequestBaseRepoPermissions permissions?;
    @jsondata:Name {value: "temp_clone_token"}
    string tempCloneToken?;
    @jsondata:Name {value: "releases_url"}
    string releasesUrl;
...
public type CommentNumberReactionsBody1 record {
...
public type RepositoryAdvisoryUpdatePackage record {
...
public type RepositoryRuleCommitterEmailPattern record {
    ...
    RepositoryRuleCommitterEmailPatternParameters parameters?;
};
...
public type PullRequestBaseRepoOwner record {
    @jsondata:Name {value: "gists_url"}
    string gistsUrl;
    @jsondata:Name {value: "repos_url"}
    string reposUrl;
...
public type CodespaceWithFullRepositoryRuntimeConstraints record {
...
public type NullableRepositoryTemplateRepositoryOwner record {
    @jsondata:Name {value: "gists_url"}
    string gistsUrl?;
    @jsondata:Name {value: "repos_url"}
    string reposUrl?;
...
public type DemilestonedIssueEventMilestone record {
    string title;
};

public type DiscussionsdiscussionNumberBody1 record {
...
public type BranchRestrictionPolicyUsers record {
    @jsondata:Name {value: "gists_url"}
    string gistsUrl?;
    @jsondata:Name {value: "repos_url"}
    string reposUrl?;
...
public type PullRequestBaseUser record {
    @jsondata:Name {value: "gists_url"}
    string gistsUrl;
    @jsondata:Name {value: "repos_url"}
    string reposUrl;
...
public type BranchProtectionAllowDeletions record {
    boolean enabled?;
};
...
public type BranchProtectionRequiredConversationResolution record {
    boolean enabled?;
};
...
public type NullableMinimalRepository record {
    ...
    @jsondata:Name {value: "subscribers_url"}
    string subscribersUrl;
    NullableMinimalRepositoryPermissions permissions?;
    @jsondata:Name {value: "temp_clone_token"}
    string tempCloneToken?;
    @jsondata:Name {value: "releases_url"}
    string releasesUrl;
...
public type ReposownerrepoissuesissueNumberlabelsLabels1 record {
    string name;
};
...
public type RepositoryRuleCommitAuthorEmailPattern record {
    ...
    RepositoryRuleCommitAuthorEmailPatternParameters parameters?;
};
...
public type NullableRepositoryPermissions record {
    boolean pull;
    boolean maintain?;
    boolean admin;
    boolean triage?;
...
public type ProtectedBranch record {
    ...
    string url;
    @jsondata:Name {value: "allow_force_pushes"}
    ProtectedBranchAllowForcePushes allowForcePushes?;
    @jsondata:Name {value: "lock_branch"}
    ProtectedBranchLockBranch lockBranch?;
    @jsondata:Name {value: "required_conversation_resolution"}
    ProtectedBranchRequiredConversationResolution requiredConversationResolution?;
    @jsondata:Name {value: "block_creations"}
    ProtectedBranchBlockCreations blockCreations?;
    @jsondata:Name {value: "allow_deletions"}
    ProtectedBranchAllowDeletions allowDeletions?;
};
...
public type NullableRepository record {
    ...
    NullableRepositoryPermissions permissions?;
    @jsondata:Name {value: "subscribers_url"}
    string subscribersUrl;
    @jsondata:Name {value: "temp_clone_token"}
    string tempCloneToken?;
...
public type NullableIntegration record {
    ...
    @jsondata:Name {value: "updated_at"}
    string updatedAt;
    NullableIntegrationPermissions permissions;
    @jsondata:Name {value: "html_url"}
    string htmlUrl;
...
public type WorkflowRunUsageBillable record {
    ...
    WorkflowRunUsageBillableMACOS mACOS?;
    @jsondata:Name {value: "WINDOWS"}
    WorkflowRunUsageBillableWINDOWS wINDOWS?;
};
...
public type ProtectedBranchBlockCreations record {|
    boolean enabled;
|};

public type PullRequestMinimalBase record {
    string ref;
...
public type ProtectionRulesProtectionRulesAnyOf12 record {
    ...
    string 'type;
    # The people or teams that may approve jobs that reference the environment. You can list up to six users or teams as reviewers. The reviewers must have at least read access to the repository. Only one of the required reviewers needs to approve the job for it to proceed
    ProtectionRulesReviewers[] reviewers?;
    @jsondata:Name {value: "node_id"}
    string nodeId;
};
...
public type WorkflowRunUsageBillableMACOS record {
    @jsondata:Name {value: "job_runs"}
    WorkflowRunUsageBillableMACOSJobRuns[] jobRuns?;
    @jsondata:Name {value: "total_ms"}
    int totalMs;
    int jobs;
};

public type CommentscommentNumberBody record {
...
public type ClientIdTokenBody2 record {
    # The access_token of the OAuth or GitHub application
    @jsondata:Name {value: "access_token"}
    string accessToken;
};

public type ClientIdTokenBody1 record {
...
public type PullRequestHeadRepoPermissions record {
    boolean pull;
    boolean maintain?;
    boolean admin;
    boolean triage?;
...
public type PullRequestHeadRepo record {
    ...
    @jsondata:Name {value: "subscribers_url"}
    string subscribersUrl;
    PullRequestHeadRepoPermissions permissions?;
    @jsondata:Name {value: "temp_clone_token"}
    string tempCloneToken?;
    @jsondata:Name {value: "releases_url"}
    string releasesUrl;
...
public type FileCommitCommit record {
    FileCommitCommitCommitter committer?;
...
public type WorkflowUsageBillableWINDOWS record {
    @jsondata:Name {value: "total_ms"}
    int totalMs?;
};
...
public type TopicSearchResultItemTopicRelation1 record {
    string name?;
    int id?;
    @jsondata:Name {value: "topic_id"}
    int topicId?;
...
public type RepositoryAdvisoryUpdate record {|
    ...
    string? cveId?;
    # A list of users receiving credit for their participation in the security advisory
    RepositoryAdvisoryUpdateCredits[]? credits?;
    # The CVSS vector that calculates the severity of the advisory. You must choose between setting this field or `severity`
    @jsondata:Name {value: "cvss_vector_string"}
    string? cvssVectorString?;
    ...
    string description?;
    # A product affected by the vulnerability detailed in a repository security advisory
    RepositoryAdvisoryUpdateVulnerabilities[] vulnerabilities?;
...
public type NullableIssuePullRequest record {
    @jsondata:Name {value: "patch_url"}
    string? patchUrl;
    @jsondata:Name {value: "merged_at"}
    string? mergedAt?;
...
public type ProtectedBranchAllowForcePushes record {|
    boolean enabled;
|};
...
public type BranchRestrictionPolicy record {
    ...
    string appsUrl;
    BranchRestrictionPolicyUsers[] users;
...
public type RepoProjectsBody record {
...
public type DiscussionNumberReactionsBody1 record {
    # The [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions) to add to the team discussion
    "+1"|"-1"|"laugh"|"confused"|"heart"|"hooray"|"rocket"|"eyes" content;
};
...
public type RepositoryAdvisoryCvss record {
    # The CVSS score
    decimal? score;
    # The CVSS vector
    @jsondata:Name {value: "vector_string"}
...
public type GistCommitChangeStatus record {
    int total?;
    int additions?;
    int deletions?;
};
...
public type HookIdConfigBody1 record {|
    @jsondata:Name {value: "content_type"}
    WebhookConfigContentType contentType?;
    @jsondata:Name {value: "insecure_ssl"}
    WebhookConfigInsecureSsl insecureSsl?;
...
public type BranchProtection record {
    ...
    boolean enabled?;
    @jsondata:Name {value: "allow_force_pushes"}
    BranchProtectionAllowForcePushes allowForcePushes?;
    @jsondata:Name {value: "lock_branch"}
    BranchProtectionLockBranch lockBranch?;
    @jsondata:Name {value: "block_creations"}
    BranchProtectionBlockCreations blockCreations?;
    @jsondata:Name {value: "required_conversation_resolution"}
    BranchProtectionRequiredConversationResolution requiredConversationResolution?;
    string name?;
    @jsondata:Name {value: "allow_deletions"}
    BranchProtectionAllowDeletions allowDeletions?;
    @jsondata:Name {value: "protection_url"}
    string protectionUrl?;
};
...
public type ConvertedNoteToIssueIssueEventProjectCard record {
    @jsondata:Name {value: "project_id"}
    int projectId;
    @jsondata:Name {value: "column_name"}
    string columnName;
...
public type RunIdRerunBody record {
    # Whether to enable debug logging for the re-run
    @jsondata:Name {value: "enable_debug_logging"}
    boolean enableDebugLogging = false;
};
...
public type PrivateUserPlan record {
    @jsondata:Name {value: "private_repos"}
    int privateRepos;
    string name;
    int collaborators;
...
public type ContentFileLinks record {
    string? git;
    string self;
    string? html;
};
...
public type ReposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsOneOf1123 record {
    @constraint:Array {minLength: 1}
    ReposownerrepoissuesissueNumberlabelsLabels1[] labels?;
};
...
public type PullRequestReviewLinksPullRequest record {
    string href;
};
...
# Identifying information for the git-user
public type TimelineCommittedEventAuthor record {
    # Timestamp of the commit
    string date;
    # Name of the git user
    string name;
...
public type RepositoryRuleCommitAuthorEmailPatternParameters record {
    # If true, the rule will fail if the pattern matches
    boolean negate?;
    # How this rule will appear to users
    string name?;
...
# The name of the package affected by the vulnerability
public type PrivateVulnerabilityReportCreatePackage record {
    SecurityAdvisoryEcosystems ecosystem;
    # The unique package name within its ecosystem
    string? name?;
};
...
public type IssueNumberCommentsBody record {
    # The contents of the comment
    string body;
};
...
public type NullableRepositoryTemplateRepository record {
    ...
    @jsondata:Name {value: "subscribers_url"}
    string subscribersUrl?;
    NullableRepositoryTemplateRepositoryPermissions permissions?;
    @jsondata:Name {value: "temp_clone_token"}
    string tempCloneToken?;
    @jsondata:Name {value: "releases_url"}
    string releasesUrl?;
    ...
    @jsondata:Name {value: "has_pages"}
    boolean hasPages?;
    NullableRepositoryTemplateRepositoryOwner owner?;
    @jsondata:Name {value: "allow_squash_merge"}
    boolean allowSquashMerge?;
    @jsondata:Name {value: "commits_url"}
    string commitsUrl?;
...
public type DiscussionNumberCommentsBody1 record {
    # The discussion comment's body text
    string body;
};
...
public type RepositoryAdvisoryCwes record {
    # The Common Weakness Enumeration (CWE) identifier
    @jsondata:Name {value: "cwe_id"}
    string cweId;
    # The name of the CWE
...
public type ProtectedBranchAllowDeletions record {|
    boolean enabled;
|};
...
public type ProjectIdColumnsBody record {
    # Name of the project column
    string name;
};
...
public type WorkflowUsageBillable record {
    ...
    @jsondata:Name {value: "MACOS"}
    WorkflowUsageBillableMACOS mACOS?;
    @jsondata:Name {value: "WINDOWS"}
    WorkflowUsageBillableWINDOWS wINDOWS?;
};
...
# Details for the vulnerable dependency
public type DependabotAlertDependency record {
    DependabotAlertPackage package?;
    # The full path to the dependency manifest file, relative to the root of the repository
    @jsondata:Name {value: "manifest_path"}
    string manifestPath?;
...
# The set of permissions for the GitHub app
public type NullableIntegrationPermissions record {|
    string issues?;
    string checks?;
    string metadata?;
    string contents?;
...
public type WorkflowRunUsageBillableWINDOWSJobRuns record {
    @jsondata:Name {value: "duration_ms"}
    int durationMs;
    @jsondata:Name {value: "job_id"}
    int jobId;
...
public type ContentSubmoduleLinks record {
    string? git;
    string self;
    string? html;
};
...
public type RunnersGenerateJitconfigBody1 record {
    # The working directory to be used for job execution, relative to the runner install directory
    @jsondata:Name {value: "work_folder"}
    string workFolder = "_work";
    # The name of the new runner
...
public type CommentscommentIdBody3 record {
...
public type PrivateVulnerabilityReportCreateVulnerabilities record {|
    PrivateVulnerabilityReportCreatePackage package;
    # The functions in the package that are affected
    @jsondata:Name {value: "vulnerable_functions"}
    string[]? vulnerableFunctions?;
    # The range of the package versions affected by the vulnerability
...
public type TimelineCommittedEventParents record {
    @jsondata:Name {value: "html_url"}
    string htmlUrl;
    # SHA for the commit
    string sha;
...
public type BranchProtectionAllowForcePushes record {
    boolean enabled?;
};
...
public type TeamIdDiscussionsBody record {
    # Private posts are only visible to team members, organization owners, and team maintainers. Public posts are visible to all members of the organization. Set to `true` to create a private post
    boolean 'private = false;
    # The discussion post's title
    string title;
...
public type TimelineCommittedEvent record {
    ...
    @jsondata:Name {value: "node_id"}
    string nodeId;
    TimelineCommittedEventParents[] parents;
};
...
public type TopicSearchResultItemAliases record {
    @jsondata:Name {value: "topic_relation"}
    TopicSearchResultItemTopicRelation1 topicRelation?;
};
...
public type SecurityAndAnalysisSecretScanning record {
    "enabled"|"disabled" status?;
};
...
public type PullRequestHeadUser record {
    @jsondata:Name {value: "gists_url"}
    string gistsUrl;
    @jsondata:Name {value: "repos_url"}
    string reposUrl;
...
public type PullRequestReviewLinksHtml record {
    string href;
};
...
public type GpgKeyEmails1 record {
    boolean verified?;
    string email?;
};
...
public type TimelineReviewedEventLinksPullRequest record {
    string href;
};
...
public type WorkflowUsageBillableMACOS record {
    @jsondata:Name {value: "total_ms"}
    int totalMs?;
};
...
public type RepositoryAdvisory record {|
    ...
    SimpleUser? author;
    RepositoryAdvisoryIdentifiers[] identifiers;
    # The API URL for the advisory
    string url;
    # The GitHub Security Advisory ID
    @jsondata:Name {value: "ghsa_id"}
...
public type NullableMinimalRepositoryPermissions record {
    boolean pull?;
    boolean maintain?;
    boolean admin?;
    boolean triage?;
...
public type CommentscommentNumberBody1 record {
    # The discussion comment's body text
    string body;
};
...
public type PullRequestMinimalBaseRepo record {
    string name;
    int id;
    string url;
};
...
public type NullableIssue record {
    ...
    "completed"|"reopened"|"not_planned"? stateReason?;
    @jsondata:Name {value: "pull_request"}
    NullableIssuePullRequest pullRequest?;
    int comments;
    @jsondata:Name {value: "closed_at"}
    string? closedAt;
    # URL for the issue
...
public type ReposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsOneOf11234Inner record {
    string name;
};
...
# Details about the codespace's git repository
public type CodespaceWithFullRepositoryGitStatus record {
    # The number of commits the local repository is behind the remote
    int behind?;
    # The current branch (or SHA if in detached HEAD state) of the local repository
    string ref?;
...
public type RepositoryRuleCommitterEmailPatternParameters record {
    # If true, the rule will fail if the pattern matches
    boolean negate?;
    # How this rule will appear to users
    string name?;
...
public type PrivateVulnerabilityReportCreate record {|
    ...
    PrivateVulnerabilityReportCreateVulnerabilities[]? vulnerabilities?;
    # A list of Common Weakness Enumeration (CWE) IDs
    @jsondata:Name {value: "cwe_ids"}
    string[]? cweIds?;
|};
...
public type MovedColumnInProjectIssueEventProjectCard record {
    @jsondata:Name {value: "project_id"}
    int projectId;
    @jsondata:Name {value: "column_name"}
    string columnName;
...
public type VariablesnameBody2 record {
    # The name of the variable
    string name?;
    # The value of the variable
    string value?;
...
public type RepositoryAdvisoryUpdateVulnerabilities record {|
    RepositoryAdvisoryUpdatePackage package;
    # The functions in the package that are affected
    @jsondata:Name {value: "vulnerable_functions"}
    string[]? vulnerableFunctions?;
    # The range of the package versions affected by the vulnerability
...
public type ReposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsOneOf1234Inner record {
    string name;
};
...
public type RunIdRerunFailedJobsBody record {
    # Whether to enable debug logging for the re-run
    @jsondata:Name {value: "enable_debug_logging"}
    boolean enableDebugLogging = false;
};
...
public type CodespaceWithFullRepository record {
    ...
    SimpleUser owner;
    @jsondata:Name {value: "runtime_constraints"}
    CodespaceWithFullRepositoryRuntimeConstraints runtimeConstraints?;
    @jsondata:Name {value: "recent_folders"}
    string[] recentFolders;
    # Duration in minutes after codespace has gone idle in which it will be deleted. Must be integer minutes between 0 and 43200 (30 days)
    @jsondata:Name {value: "retention_period_minutes"}
...
public type RepositoryRuleTagNamePatternParameters record {
    # If true, the rule will fail if the pattern matches
    boolean negate?;
    # How this rule will appear to users
    string name?;
...
@constraint:Array {minLength: 1}
public type ReposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsOneOf1234 ReposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsreposownerrepoissuesissueNumberlabelsOneOf1234Inner[];
...
public type RepositoryRuleTagNamePattern record {
    ...
    RepositoryRuleTagNamePatternParameters parameters?;
};
...
# Identifying information for the git-user
public type TimelineCommittedEventCommitter record {
    # Timestamp of the commit
    string date;
    # Name of the git user
    string name;
...
public type BranchProtectionBlockCreations record {
    boolean enabled?;
};
...
public type RepositoryAdvisoryUpdateCredits record {|
    # The username of the user credited
    string login;
    SecurityAdvisoryCreditTypes 'type;
|};

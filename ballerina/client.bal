...
public isolated client class Client {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get advisories/[string ghsa_id](map<string|string[]> headers = {}) returns GlobalAdvisory|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get app/hook/deliveries/[int delivery_id](map<string|string[]> headers = {}) returns HookDelivery|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Accepted 
    resource isolated function post app/hook/deliveries/[int delivery_id]/attempts(map<string|string[]> headers = {}) returns record {}|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get app/installations/[int installation_id](map<string|string[]> headers = {}) returns Installation|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete app/installations/[int installation_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/app/installations/${getEncodedUri(installation_id)}`;
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post app/installations/[int installation_id]/access_tokens(InstallationIdAccessTokensBody payload, map<string|string[]> headers = {}) returns InstallationToken|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put app/installations/[int installation_id]/suspended(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete app/installations/[int installation_id]/suspended(map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/app/installations/${getEncodedUri(installation_id)}/suspended`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete applications/[string client_id]/grant(ClientIdGrantBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post applications/[string client_id]/token(ClientIdTokenBody payload, map<string|string[]> headers = {}) returns Authorization|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete applications/[string client_id]/token(ClientIdTokenBody1 payload, map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/applications/${getEncodedUri(client_id)}/token`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch applications/[string client_id]/token(ClientIdTokenBody2 payload, map<string|string[]> headers = {}) returns Authorization|error {
        string resourcePath = string `/applications/${getEncodedUri(client_id)}/token`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post applications/[string client_id]/token/scoped(TokenScopedBody payload, map<string|string[]> headers = {}) returns Authorization|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get apps/[string app_slug](map<string|string[]> headers = {}) returns Integration|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get assignments/[int assignment_id](map<string|string[]> headers = {}) returns ClassroomAssignment|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get assignments/[int assignment_id]/accepted_assignments(map<string|string[]> headers = {}, *ClassroomListAcceptedAssigmentsForAnAssignmentQueries queries) returns ClassroomAcceptedAssignment[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get assignments/[int assignment_id]/grades(map<string|string[]> headers = {}) returns ClassroomAssignmentGrade[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get classrooms/[int classroom_id](map<string|string[]> headers = {}) returns Classroom|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get classrooms/[int classroom_id]/assignments(map<string|string[]> headers = {}, *ClassroomListAssignmentsForAClassroomQueries queries) returns SimpleClassroomAssignment[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get gists/[string gist_id](map<string|string[]> headers = {}) returns GistSimple|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete gists/[string gist_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/gists/${getEncodedUri(gist_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch gists/[string gist_id](GistsgistIdBody payload, map<string|string[]> headers = {}) returns GistSimple|error {
        string resourcePath = string `/gists/${getEncodedUri(gist_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get gists/[string gist_id]/comments(map<string|string[]> headers = {}, *GistsListCommentsQueries queries) returns GistComment[]|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post gists/[string gist_id]/comments(GistIdCommentsBody payload, map<string|string[]> headers = {}) returns GistComment|error? {
        string resourcePath = string `/gists/${getEncodedUri(gist_id)}/comments`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get gists/[string gist_id]/comments/[int comment_id](map<string|string[]> headers = {}) returns GistComment|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete gists/[string gist_id]/comments/[int comment_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/gists/${getEncodedUri(gist_id)}/comments/${getEncodedUri(comment_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch gists/[string gist_id]/comments/[int comment_id](CommentscommentIdBody payload, map<string|string[]> headers = {}) returns GistComment|error {
        string resourcePath = string `/gists/${getEncodedUri(gist_id)}/comments/${getEncodedUri(comment_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get gists/[string gist_id]/commits(map<string|string[]> headers = {}, *GistsListCommitsQueries queries) returns GistCommit[]|error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get gists/[string gist_id]/forks(map<string|string[]> headers = {}, *GistsListForksQueries queries) returns GistSimple[]|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post gists/[string gist_id]/forks(map<string|string[]> headers = {}) returns BaseGist|error? {
        string resourcePath = string `/gists/${getEncodedUri(gist_id)}/forks`;
        http:Request request = new;
        return self.clientEp->post(resourcePath, request, headers);
    }
    ...
    resource isolated function get gists/[string gist_id]/star(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put gists/[string gist_id]/star(map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/gists/${getEncodedUri(gist_id)}/star`;
        http:Request request = new;
        return self.clientEp->put(resourcePath, request, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete gists/[string gist_id]/star(map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/gists/${getEncodedUri(gist_id)}/star`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get gists/[string gist_id]/[string sha](map<string|string[]> headers = {}) returns GistSimple|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get marketplace_listing/accounts/[int account_id](map<string|string[]> headers = {}) returns MarketplacePurchase|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get marketplace_listing/plans/[int plan_id]/accounts(map<string|string[]> headers = {}, *AppsListAccountsForPlanQueries queries) returns MarketplacePurchase[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get marketplace_listing/stubbed/accounts/[int account_id](map<string|string[]> headers = {}) returns MarketplacePurchase|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get marketplace_listing/stubbed/plans/[int plan_id]/accounts(map<string|string[]> headers = {}, *AppsListAccountsForPlanStubbedQueries queries) returns MarketplacePurchase[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get notifications/threads/[int thread_id](map<string|string[]> headers = {}) returns NotificationThread|error? {
    ...
    resource isolated function patch notifications/threads/[int thread_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/notifications/threads/${getEncodedUri(thread_id)}`;
        http:Request request = new;
        return self.clientEp->patch(resourcePath, request, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get notifications/threads/[int thread_id]/subscription(map<string|string[]> headers = {}) returns ThreadSubscription|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put notifications/threads/[int thread_id]/subscription(ThreadIdSubscriptionBody payload, map<string|string[]> headers = {}) returns ThreadSubscription|error? {
        string resourcePath = string `/notifications/threads/${getEncodedUri(thread_id)}/subscription`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete notifications/threads/[int thread_id]/subscription(map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/notifications/threads/${getEncodedUri(thread_id)}/subscription`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put orgs/[string org]/actions/permissions/repositories/[int repository_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/actions/permissions/repositories/[int repository_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/actions/permissions/repositories/${getEncodedUri(repository_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/actions/runners/[int runner_id](map<string|string[]> headers = {}) returns Runner|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/actions/runners/[int runner_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/actions/runners/${getEncodedUri(runner_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/actions/runners/[int runner_id]/labels(map<string|string[]> headers = {}) returns RunnerLabelResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put orgs/[string org]/actions/runners/[int runner_id]/labels(RunnerIdLabelsBody payload, map<string|string[]> headers = {}) returns RunnerLabelResponse|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/actions/runners/${getEncodedUri(runner_id)}/labels`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post orgs/[string org]/actions/runners/[int runner_id]/labels(RunnerIdLabelsBody1 payload, map<string|string[]> headers = {}) returns RunnerLabelResponse|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/actions/runners/${getEncodedUri(runner_id)}/labels`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/actions/runners/[int runner_id]/labels(map<string|string[]> headers = {}) returns RunnerLabelResponse|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/actions/runners/${getEncodedUri(runner_id)}/labels`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/actions/runners/[int runner_id]/labels/[string name](map<string|string[]> headers = {}) returns RunnerLabelResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/actions/secrets/[string secret_name](map<string|string[]> headers = {}) returns OrganizationActionsSecret|error {
    ...
    resource isolated function put orgs/[string org]/actions/secrets/[string secret_name](SecretssecretNameBody payload, map<string|string[]> headers = {}) returns EmptyObject|error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/actions/secrets/${getEncodedUri(secret_name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/actions/secrets/[string secret_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/actions/secrets/${getEncodedUri(secret_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/actions/secrets/[string secret_name]/repositories(map<string|string[]> headers = {}, *ActionsListSelectedReposForOrgSecretQueries queries) returns MinimalRepositoryResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put orgs/[string org]/actions/secrets/[string secret_name]/repositories(SecretNameRepositoriesBody payload, map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/actions/secrets/${getEncodedUri(secret_name)}/repositories`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function put orgs/[string org]/actions/secrets/[string secret_name]/repositories/[int repositoryId](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/actions/secrets/${getEncodedUri(secret_name)}/repositories/${getEncodedUri(repositoryId)}`;
        http:Request request = new;
        return self.clientEp->put(resourcePath, request, headers);
    }
    ...
    resource isolated function delete orgs/[string org]/actions/secrets/[string secret_name]/repositories/[int repositoryId](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/actions/secrets/${getEncodedUri(secret_name)}/repositories/${getEncodedUri(repositoryId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/codespaces/secrets/[string secret_name](map<string|string[]> headers = {}) returns CodespacesOrgSecret|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response when creating a secret 
    resource isolated function put orgs/[string org]/codespaces/secrets/[string secret_name](SecretssecretNameBody1 payload, map<string|string[]> headers = {}) returns EmptyObject|error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/codespaces/secrets/${getEncodedUri(secret_name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/codespaces/secrets/[string secret_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/codespaces/secrets/${getEncodedUri(secret_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/codespaces/secrets/[string secret_name]/repositories(map<string|string[]> headers = {}, *CodespacesListSelectedReposForOrgSecretQueries queries) returns MinimalRepositoryResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put orgs/[string org]/codespaces/secrets/[string secret_name]/repositories(SecretNameRepositoriesBody1 payload, map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/codespaces/secrets/${getEncodedUri(secret_name)}/repositories`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - No Content when repository was added to the selected list 
    resource isolated function put orgs/[string org]/codespaces/secrets/[string secret_name]/repositories/[int repositoryId](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/codespaces/secrets/${getEncodedUri(secret_name)}/repositories/${getEncodedUri(repositoryId)}`;
        http:Request request = new;
        return self.clientEp->put(resourcePath, request, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response when repository was removed from the selected list 
    resource isolated function delete orgs/[string org]/codespaces/secrets/[string secret_name]/repositories/[int repositoryId](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/codespaces/secrets/${getEncodedUri(secret_name)}/repositories/${getEncodedUri(repositoryId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/dependabot/secrets/[string secret_name](map<string|string[]> headers = {}) returns OrganizationDependabotSecret|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response when creating a secret 
    resource isolated function put orgs/[string org]/dependabot/secrets/[string secret_name](SecretssecretNameBody2 payload, map<string|string[]> headers = {}) returns EmptyObject|error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/dependabot/secrets/${getEncodedUri(secret_name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/dependabot/secrets/[string secret_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/dependabot/secrets/${getEncodedUri(secret_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/dependabot/secrets/[string secret_name]/repositories(map<string|string[]> headers = {}, *DependabotListSelectedReposForOrgSecretQueries queries) returns MinimalRepositoryResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put orgs/[string org]/dependabot/secrets/[string secret_name]/repositories(SecretNameRepositoriesBody2 payload, map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/dependabot/secrets/${getEncodedUri(secret_name)}/repositories`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - No Content when repository was added to the selected list 
    resource isolated function put orgs/[string org]/dependabot/secrets/[string secret_name]/repositories/[int repositoryId](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/dependabot/secrets/${getEncodedUri(secret_name)}/repositories/${getEncodedUri(repositoryId)}`;
        http:Request request = new;
        return self.clientEp->put(resourcePath, request, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response when repository was removed from the selected list 
    resource isolated function delete orgs/[string org]/dependabot/secrets/[string secret_name]/repositories/[int repositoryId](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/dependabot/secrets/${getEncodedUri(secret_name)}/repositories/${getEncodedUri(repositoryId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/hooks/[int hook_id](map<string|string[]> headers = {}) returns OrgHook|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/hooks/[int hook_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/hooks/${getEncodedUri(hook_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch orgs/[string org]/hooks/[int hook_id](HookshookIdBody payload, map<string|string[]> headers = {}) returns OrgHook|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/hooks/${getEncodedUri(hook_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/hooks/[int hook_id]/config(map<string|string[]> headers = {}) returns WebhookConfig|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch orgs/[string org]/hooks/[int hook_id]/config(HookIdConfigBody payload, map<string|string[]> headers = {}) returns WebhookConfig|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/hooks/${getEncodedUri(hook_id)}/config`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/hooks/[int hook_id]/deliveries(map<string|string[]> headers = {}, *OrgsListWebhookDeliveriesQueries queries) returns HookDeliveryItem[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/hooks/[int hook_id]/deliveries/[int delivery_id](map<string|string[]> headers = {}) returns HookDelivery|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Accepted 
    resource isolated function post orgs/[string org]/hooks/[int hook_id]/deliveries/[int delivery_id]/attempts(map<string|string[]> headers = {}) returns record {}|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post orgs/[string org]/hooks/[int hook_id]/pings(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/invitations/[int invitation_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/invitations/[int invitation_id]/teams(map<string|string[]> headers = {}, *OrgsListInvitationTeamsQueries queries) returns Team[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Accepted 
    resource isolated function delete orgs/[string org]/members/[string username]/codespaces/[string codespace_name](map<string|string[]> headers = {}) returns record {}|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post orgs/[string org]/members/[string username]/codespaces/[string codespace_name]/stop(map<string|string[]> headers = {}) returns Codespace|error? {
    ...
    resource isolated function get orgs/[string org]/migrations/[int migration_id](map<string|string[]> headers = {}, *MigrationsGetStatusForOrgQueries queries) returns Migration|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/migrations/[int migration_id]/archive(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/migrations/[int migration_id]/archive(map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/migrations/${getEncodedUri(migration_id)}/archive`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete orgs/[string org]/migrations/[int migration_id]/repos/[string repo_name]/'lock(map<string|string[]> headers = {}) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/migrations/[int migration_id]/repositories(map<string|string[]> headers = {}, *MigrationsListReposForOrgQueries queries) returns MinimalRepository[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name](map<string|string[]> headers = {}) returns Package|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/packages/${getEncodedUri(package_type)}/${getEncodedUri(package_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function post orgs/[string org]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/restore(map<string|string[]> headers = {}, *PackagesRestorePackageForOrgQueries queries) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions(map<string|string[]> headers = {}, *PackagesGetAllPackageVersionsForPackageOwnedByOrgQueries queries) returns PackageVersion[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions/[int package_version_id](map<string|string[]> headers = {}) returns PackageVersion|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions/[int package_version_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/packages/${getEncodedUri(package_type)}/${getEncodedUri(package_name)}/versions/${getEncodedUri(package_version_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post orgs/[string org]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions/[int package_version_id]/restore(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Internal Error 
    resource isolated function post orgs/[string org]/personal\-access\-tokens/[int pat_id](PersonalAccessTokenspatIdBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/rulesets/rule\-suites/[int rule_suite_id](map<string|string[]> headers = {}) returns RuleSuite|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put orgs/[string org]/security\-managers/teams/[string team_slug](map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/security\-managers/teams/[string team_slug](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/security-managers/teams/${getEncodedUri(team_slug)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug](map<string|string[]> headers = {}) returns TeamFull|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/teams/[string team_slug](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    resource isolated function patch orgs/[string org]/teams/[string team_slug](TeamsteamSlugBody payload, map<string|string[]> headers = {}) returns TeamFull|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/discussions(map<string|string[]> headers = {}, *TeamsListDiscussionsInOrgQueries queries) returns TeamDiscussion[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post orgs/[string org]/teams/[string team_slug]/discussions(TeamSlugDiscussionsBody payload, map<string|string[]> headers = {}) returns TeamDiscussion|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/discussions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number](map<string|string[]> headers = {}) returns TeamDiscussion|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/discussions/${getEncodedUri(discussion_number)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number](DiscussionsdiscussionNumberBody payload, map<string|string[]> headers = {}) returns TeamDiscussion|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/discussions/${getEncodedUri(discussion_number)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/comments(map<string|string[]> headers = {}, *TeamsListDiscussionCommentsInOrgQueries queries) returns TeamDiscussionComment[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/comments(DiscussionNumberCommentsBody payload, map<string|string[]> headers = {}) returns TeamDiscussionComment|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/discussions/${getEncodedUri(discussion_number)}/comments`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/comments/[int comment_number](map<string|string[]> headers = {}) returns TeamDiscussionComment|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/comments/[int comment_number](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/discussions/${getEncodedUri(discussion_number)}/comments/${getEncodedUri(comment_number)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/comments/[int comment_number](CommentscommentNumberBody payload, map<string|string[]> headers = {}) returns TeamDiscussionComment|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/discussions/${getEncodedUri(discussion_number)}/comments/${getEncodedUri(comment_number)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/comments/[int comment_number]/reactions(map<string|string[]> headers = {}, *ReactionsListForTeamDiscussionCommentInOrgQueries queries) returns Reaction[]|error {
    ...
    resource isolated function post orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/comments/[int comment_number]/reactions(CommentNumberReactionsBody payload, map<string|string[]> headers = {}) returns Reaction|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/discussions/${getEncodedUri(discussion_number)}/comments/${getEncodedUri(comment_number)}/reactions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/comments/[int comment_number]/reactions/[int reaction_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/reactions(map<string|string[]> headers = {}, *ReactionsListForTeamDiscussionInOrgQueries queries) returns Reaction[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/reactions(DiscussionNumberReactionsBody payload, map<string|string[]> headers = {}) returns Reaction|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/discussions/${getEncodedUri(discussion_number)}/reactions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/teams/[string team_slug]/discussions/[int discussion_number]/reactions/[int reaction_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/invitations(map<string|string[]> headers = {}, *TeamsListPendingInvitationsInOrgQueries queries) returns OrganizationInvitation[]|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/members(map<string|string[]> headers = {}, *TeamsListMembersInOrgQueries queries) returns SimpleUser[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/memberships/[string username](map<string|string[]> headers = {}) returns TeamMembership|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put orgs/[string org]/teams/[string team_slug]/memberships/[string username](MembershipsusernameBody1 payload, map<string|string[]> headers = {}) returns TeamMembership|error {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/memberships/${getEncodedUri(username)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/teams/[string team_slug]/memberships/[string username](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/memberships/${getEncodedUri(username)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/projects(map<string|string[]> headers = {}, *TeamsListProjectsInOrgQueries queries) returns TeamProject[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/projects/[int project_id](map<string|string[]> headers = {}) returns TeamProject|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put orgs/[string org]/teams/[string team_slug]/projects/[int project_id](ProjectsprojectIdBody payload, map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/projects/${getEncodedUri(project_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/teams/[string team_slug]/projects/[int project_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/projects/${getEncodedUri(project_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get orgs/[string org]/teams/[string team_slug]/repos(map<string|string[]> headers = {}, *TeamsListReposInOrgQueries queries) returns MinimalRepository[]|error {
    ...
    resource isolated function get orgs/[string org]/teams/[string team_slug]/repos/[string owner]/[string repo](map<string|string[]> headers = {}) returns TeamRepository|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put orgs/[string org]/teams/[string team_slug]/repos/[string owner]/[string repo](OwnerrepoBody payload, map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete orgs/[string org]/teams/[string team_slug]/repos/[string owner]/[string repo](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/orgs/${getEncodedUri(org)}/teams/${getEncodedUri(team_slug)}/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    resource isolated function get orgs/[string org]/teams/[string team_slug]/teams(map<string|string[]> headers = {}, *TeamsListChildInOrgQueries queries) returns Team[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get projects/columns/cards/[int card_id](map<string|string[]> headers = {}) returns ProjectCard|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete projects/columns/cards/[int card_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/projects/columns/cards/${getEncodedUri(card_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch projects/columns/cards/[int card_id](CardscardIdBody payload, map<string|string[]> headers = {}) returns ProjectCard|error? {
        string resourcePath = string `/projects/columns/cards/${getEncodedUri(card_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post projects/columns/cards/[int card_id]/moves(CardIdMovesBody payload, map<string|string[]> headers = {}) returns record {||}|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get projects/columns/[int column_id](map<string|string[]> headers = {}) returns ProjectColumn|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete projects/columns/[int column_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/projects/columns/${getEncodedUri(column_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch projects/columns/[int column_id](ColumnscolumnIdBody payload, map<string|string[]> headers = {}) returns ProjectColumn|error? {
        string resourcePath = string `/projects/columns/${getEncodedUri(column_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get projects/columns/[int column_id]/cards(map<string|string[]> headers = {}, *ProjectsListCardsQueries queries) returns ProjectCard[]|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post projects/columns/[int column_id]/cards(ColumnIdCardsBody payload, map<string|string[]> headers = {}) returns ProjectCard|error? {
        string resourcePath = string `/projects/columns/${getEncodedUri(column_id)}/cards`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post projects/columns/[int column_id]/moves(ColumnIdMovesBody payload, map<string|string[]> headers = {}) returns record {||}|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get projects/[int project_id](map<string|string[]> headers = {}) returns Project|error? {
    ...
    resource isolated function delete projects/[int project_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/projects/${getEncodedUri(project_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch projects/[int project_id](ProjectsprojectIdBody1 payload, map<string|string[]> headers = {}) returns Project|error? {
        string resourcePath = string `/projects/${getEncodedUri(project_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get projects/[int project_id]/collaborators(map<string|string[]> headers = {}, *ProjectsListCollaboratorsQueries queries) returns SimpleUser[]|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put projects/[int project_id]/collaborators/[string username](CollaboratorsusernameBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete projects/[int project_id]/collaborators/[string username](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/projects/${getEncodedUri(project_id)}/collaborators/${getEncodedUri(username)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get projects/[int project_id]/collaborators/[string username]/permission(map<string|string[]> headers = {}) returns ProjectCollaboratorPermission|error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get projects/[int project_id]/columns(map<string|string[]> headers = {}, *ProjectsListColumnsQueries queries) returns ProjectColumn[]|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post projects/[int project_id]/columns(ProjectIdColumnsBody payload, map<string|string[]> headers = {}) returns ProjectColumn|error? {
        string resourcePath = string `/projects/${getEncodedUri(project_id)}/columns`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/artifacts/[int artifact_id](map<string|string[]> headers = {}) returns Artifact|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/actions/artifacts/[int artifact_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/artifacts/${getEncodedUri(artifact_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/artifacts/[int artifact_id]/[string archiveFormat](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/artifacts/${getEncodedUri(artifact_id)}/${getEncodedUri(archiveFormat)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/actions/caches/[int cache_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/jobs/[int job_id](map<string|string[]> headers = {}) returns Job|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/jobs/[int job_id]/logs(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/actions/jobs/[int job_id]/rerun(JobIdRerunBody payload, map<string|string[]> headers = {}) returns EmptyObject|error {
    ...
    resource isolated function post repos/[string owner]/[string repo]/actions/runners/generate\-jitconfig(RunnersGenerateJitconfigBody1 payload, map<string|string[]> headers = {}) returns JitConfig|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runners/[int runner_id](map<string|string[]> headers = {}) returns Runner|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/actions/runners/[int runner_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/runners/${getEncodedUri(runner_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runners/[int runner_id]/labels(map<string|string[]> headers = {}) returns RunnerLabelResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put repos/[string owner]/[string repo]/actions/runners/[int runner_id]/labels(RunnerIdLabelsBody2 payload, map<string|string[]> headers = {}) returns RunnerLabelResponse|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/runners/${getEncodedUri(runner_id)}/labels`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/actions/runners/[int runner_id]/labels(RunnerIdLabelsBody3 payload, map<string|string[]> headers = {}) returns RunnerLabelResponse|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/runners/${getEncodedUri(runner_id)}/labels`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/actions/runners/[int runner_id]/labels(map<string|string[]> headers = {}) returns RunnerLabelResponse|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/runners/${getEncodedUri(runner_id)}/labels`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/actions/runners/[int runner_id]/labels/[string name](map<string|string[]> headers = {}) returns RunnerLabelResponse|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runs/[int run_id](map<string|string[]> headers = {}, *ActionsGetWorkflowRunQueries queries) returns WorkflowRun|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/actions/runs/[int run_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/runs/${getEncodedUri(run_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runs/[int run_id]/approvals(map<string|string[]> headers = {}) returns EnvironmentApprovals[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/actions/runs/[int run_id]/approve(map<string|string[]> headers = {}) returns EmptyObject|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runs/[int run_id]/artifacts(map<string|string[]> headers = {}, *ActionsListWorkflowRunArtifactsQueries queries) returns ArtifactResponse|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runs/[int run_id]/attempts/[int attempt_number](map<string|string[]> headers = {}, *ActionsGetWorkflowRunAttemptQueries queries) returns WorkflowRun|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runs/[int run_id]/attempts/[int attempt_number]/jobs(map<string|string[]> headers = {}, *ActionsListJobsForWorkflowRunAttemptQueries queries) returns JobResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runs/[int run_id]/attempts/[int attempt_number]/logs(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/actions/runs/[int run_id]/cancel(map<string|string[]> headers = {}) returns EmptyObject|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/actions/runs/[int run_id]/deployment_protection_rule(RunIdDeploymentProtectionRuleBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    resource isolated function post repos/[string owner]/[string repo]/actions/runs/[int run_id]/force\-cancel(map<string|string[]> headers = {}) returns EmptyObject|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runs/[int run_id]/jobs(map<string|string[]> headers = {}, *ActionsListJobsForWorkflowRunQueries queries) returns JobResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runs/[int run_id]/logs(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/actions/runs/[int run_id]/logs(map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/runs/${getEncodedUri(run_id)}/logs`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runs/[int run_id]/pending_deployments(map<string|string[]> headers = {}) returns PendingDeployment[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/actions/runs/[int run_id]/pending_deployments(RunIdPendingDeploymentsBody payload, map<string|string[]> headers = {}) returns Deployment[]|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/runs/${getEncodedUri(run_id)}/pending_deployments`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/actions/runs/[int run_id]/rerun(RunIdRerunBody payload, map<string|string[]> headers = {}) returns EmptyObject|error {
    ...
    resource isolated function post repos/[string owner]/[string repo]/actions/runs/[int run_id]/rerun\-failed\-jobs(RunIdRerunFailedJobsBody payload, map<string|string[]> headers = {}) returns EmptyObject|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/runs/[int run_id]/timing(map<string|string[]> headers = {}) returns WorkflowRunUsage|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/secrets/[string secret_name](map<string|string[]> headers = {}) returns ActionsSecret|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response when creating a secret 
    resource isolated function put repos/[string owner]/[string repo]/actions/secrets/[string secret_name](SecretssecretNameBody3 payload, map<string|string[]> headers = {}) returns EmptyObject|error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/secrets/${getEncodedUri(secret_name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/actions/secrets/[string secret_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/actions/secrets/${getEncodedUri(secret_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/workflows/[workflow_id workflow_id](map<string|string[]> headers = {}) returns Workflow|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put repos/[string owner]/[string repo]/actions/workflows/[workflow_id workflow_id]/disable(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/actions/workflows/[workflow_id workflow_id]/dispatches(WorkflowIdDispatchesBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put repos/[string owner]/[string repo]/actions/workflows/[workflow_id workflow_id]/enable(map<string|string[]> headers = {}) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/workflows/[workflow_id workflow_id]/runs(map<string|string[]> headers = {}, *ActionsListWorkflowRunsQueries queries) returns WorkflowRunResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/actions/workflows/[workflow_id workflow_id]/timing(map<string|string[]> headers = {}) returns WorkflowUsage|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/autolinks/[int autolink_id](map<string|string[]> headers = {}) returns Autolink|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/autolinks/[int autolink_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/autolinks/${getEncodedUri(autolink_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/check\-runs/[int check_run_id](map<string|string[]> headers = {}) returns CheckRun|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/check\-runs/[int check_run_id](CheckRunscheckRunIdBody payload, map<string|string[]> headers = {}) returns CheckRun|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/check-runs/${getEncodedUri(check_run_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/check\-runs/[int check_run_id]/annotations(map<string|string[]> headers = {}, *ChecksListAnnotationsQueries queries) returns CheckAnnotation[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/check\-runs/[int check_run_id]/rerequest(map<string|string[]> headers = {}) returns EmptyObject|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/check\-suites/[int check_suite_id](map<string|string[]> headers = {}) returns CheckSuite|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/check-suites/${getEncodedUri(check_suite_id)}`;
        return self.clientEp->get(resourcePath, headers);
    }

    resource isolated function get repos/[string owner]/[string repo]/check\-suites/[int check_suite_id]/check\-runs(map<string|string[]> headers = {}, *ChecksListForSuiteQueries queries) returns CheckRunResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/check\-suites/[int check_suite_id]/rerequest(map<string|string[]> headers = {}) returns EmptyObject|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/code\-scanning/alerts/[AlertNumber alert_number](map<string|string[]> headers = {}) returns CodeScanningAlert|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/code\-scanning/alerts/[AlertNumber alert_number](AlertsalertNumberBody payload, map<string|string[]> headers = {}) returns CodeScanningAlert|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/code-scanning/alerts/${getEncodedUri(alert_number)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/code\-scanning/alerts/[AlertNumber alert_number]/instances(map<string|string[]> headers = {}, *CodeScanningListAlertInstancesQueries queries) returns CodeScanningAlertInstance[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/codespaces/secrets/[string secret_name](map<string|string[]> headers = {}) returns RepoCodespacesSecret|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response when creating a secret 
    resource isolated function put repos/[string owner]/[string repo]/codespaces/secrets/[string secret_name](SecretssecretNameBody4 payload, map<string|string[]> headers = {}) returns EmptyObject|error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/codespaces/secrets/${getEncodedUri(secret_name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/codespaces/secrets/[string secret_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/codespaces/secrets/${getEncodedUri(secret_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/comments/[int comment_id](map<string|string[]> headers = {}) returns CommitComment|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/comments/[int comment_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/comments/${getEncodedUri(comment_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/comments/[int comment_id](CommentscommentIdBody1 payload, map<string|string[]> headers = {}) returns CommitComment|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/comments/${getEncodedUri(comment_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/comments/[int comment_id]/reactions(map<string|string[]> headers = {}, *ReactionsListForCommitCommentQueries queries) returns Reaction[]|error {
    ...
    resource isolated function post repos/[string owner]/[string repo]/comments/[int comment_id]/reactions(CommentIdReactionsBody payload, map<string|string[]> headers = {}) returns Reaction|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/comments/${getEncodedUri(comment_id)}/reactions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/comments/[int comment_id]/reactions/[int reaction_id](map<string|string[]> headers = {}) returns error? {
    ...
    resource isolated function get repos/[string owner]/[string repo]/commits/[string commit_sha]/branches\-where\-head(map<string|string[]> headers = {}) returns BranchShort[]|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/commits/[string commit_sha]/comments(map<string|string[]> headers = {}, *ReposListCommentsForCommitQueries queries) returns CommitComment[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/commits/[string commit_sha]/comments(CommitShaCommentsBody payload, map<string|string[]> headers = {}) returns CommitComment|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/commits/${getEncodedUri(commit_sha)}/comments`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/commits/[string commit_sha]/pulls(map<string|string[]> headers = {}, *ReposListPullRequestsAssociatedWithCommitQueries queries) returns PullRequestSimple[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/dependabot/alerts/[AlertNumber alert_number](map<string|string[]> headers = {}) returns DependabotAlert|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/dependabot/alerts/[AlertNumber alert_number](AlertsalertNumberBody1 payload, map<string|string[]> headers = {}) returns DependabotAlert|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/dependabot/alerts/${getEncodedUri(alert_number)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/dependabot/secrets/[string secret_name](map<string|string[]> headers = {}) returns DependabotSecret|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response when creating a secret 
    resource isolated function put repos/[string owner]/[string repo]/dependabot/secrets/[string secret_name](SecretssecretNameBody5 payload, map<string|string[]> headers = {}) returns EmptyObject|error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/dependabot/secrets/${getEncodedUri(secret_name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/dependabot/secrets/[string secret_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/dependabot/secrets/${getEncodedUri(secret_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/deployments/[int deployment_id](map<string|string[]> headers = {}) returns Deployment|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/deployments/[int deployment_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/deployments/${getEncodedUri(deployment_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/deployments/[int deployment_id]/statuses(map<string|string[]> headers = {}, *ReposListDeploymentStatusesQueries queries) returns DeploymentStatus[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/deployments/[int deployment_id]/statuses(DeploymentIdStatusesBody payload, map<string|string[]> headers = {}) returns DeploymentStatus|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/deployments/${getEncodedUri(deployment_id)}/statuses`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/deployments/[int deployment_id]/statuses/[int statusId](map<string|string[]> headers = {}) returns DeploymentStatus|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/deployments/${getEncodedUri(deployment_id)}/statuses/${getEncodedUri(statusId)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/environments/[string environment_name](map<string|string[]> headers = {}) returns Environment|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put repos/[string owner]/[string repo]/environments/[string environment_name](EnvironmentsenvironmentNameBody payload, map<string|string[]> headers = {}) returns Environment|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/environments/${getEncodedUri(environment_name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function delete repos/[string owner]/[string repo]/environments/[string environment_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/environments/${getEncodedUri(environment_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function get repos/[string owner]/[string repo]/environments/[string environment_name]/deployment\-branch\-policies(map<string|string[]> headers = {}, *ReposListDeploymentBranchPoliciesQueries queries) returns DeploymentBranchPolicyResponse|error {
    ...
    resource isolated function post repos/[string owner]/[string repo]/environments/[string environment_name]/deployment\-branch\-policies(DeploymentBranchPolicyNamePatternWithType payload, map<string|string[]> headers = {}) returns DeploymentBranchPolicy|error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/environments/${getEncodedUri(environment_name)}/deployment-branch-policies`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/environments/[string environment_name]/deployment\-branch\-policies/[int branch_policy_id](map<string|string[]> headers = {}) returns DeploymentBranchPolicy|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put repos/[string owner]/[string repo]/environments/[string environment_name]/deployment\-branch\-policies/[int branch_policy_id](DeploymentBranchPolicyNamePattern payload, map<string|string[]> headers = {}) returns DeploymentBranchPolicy|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/environments/${getEncodedUri(environment_name)}/deployment-branch-policies/${getEncodedUri(branch_policy_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/environments/[string environment_name]/deployment\-branch\-policies/[int branch_policy_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/environments/${getEncodedUri(environment_name)}/deployment-branch-policies/${getEncodedUri(branch_policy_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    resource isolated function get repos/[string owner]/[string repo]/environments/[string environment_name]/deployment_protection_rules(map<string|string[]> headers = {}) returns DeploymentProtectionRuleResponse|error {
    ...
    resource isolated function post repos/[string owner]/[string repo]/environments/[string environment_name]/deployment_protection_rules(EnvironmentNameDeploymentProtectionRulesBody payload, map<string|string[]> headers = {}) returns DeploymentProtectionRule|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/environments/${getEncodedUri(environment_name)}/deployment_protection_rules`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function get repos/[string owner]/[string repo]/environments/[string environment_name]/deployment_protection_rules/apps(map<string|string[]> headers = {}, *ReposListCustomDeploymentRuleIntegrationsQueries queries) returns CustomDeploymentRuleAppResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/environments/[string environment_name]/deployment_protection_rules/[int protection_rule_id](map<string|string[]> headers = {}) returns DeploymentProtectionRule|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/environments/[string environment_name]/deployment_protection_rules/[int protection_rule_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/environments/${getEncodedUri(environment_name)}/deployment_protection_rules/${getEncodedUri(protection_rule_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/git/commits/[string commit_sha](map<string|string[]> headers = {}) returns GitCommit|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/hooks/[int hook_id](map<string|string[]> headers = {}) returns Hook|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/hooks/[int hook_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/hooks/${getEncodedUri(hook_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/hooks/[int hook_id](HookshookIdBody1 payload, map<string|string[]> headers = {}) returns Hook|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/hooks/${getEncodedUri(hook_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/hooks/[int hook_id]/config(map<string|string[]> headers = {}) returns WebhookConfig|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/hooks/[int hook_id]/config(HookIdConfigBody1 payload, map<string|string[]> headers = {}) returns WebhookConfig|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/hooks/${getEncodedUri(hook_id)}/config`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/hooks/[int hook_id]/deliveries(map<string|string[]> headers = {}, *ReposListWebhookDeliveriesQueries queries) returns HookDeliveryItem[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/hooks/[int hook_id]/deliveries/[int delivery_id](map<string|string[]> headers = {}) returns HookDelivery|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Accepted 
    resource isolated function post repos/[string owner]/[string repo]/hooks/[int hook_id]/deliveries/[int delivery_id]/attempts(map<string|string[]> headers = {}) returns record {}|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/hooks/[int hook_id]/pings(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/hooks/[int hook_id]/tests(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/invitations/[int invitation_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/invitations/[int invitation_id](InvitationsinvitationIdBody payload, map<string|string[]> headers = {}) returns RepositoryInvitation|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/invitations/${getEncodedUri(invitation_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/issues/comments/[int comment_id](map<string|string[]> headers = {}) returns IssueComment|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/issues/comments/[int comment_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/comments/${getEncodedUri(comment_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/issues/comments/[int comment_id](CommentscommentIdBody2 payload, map<string|string[]> headers = {}) returns IssueComment|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/comments/${getEncodedUri(comment_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/issues/comments/[int comment_id]/reactions(map<string|string[]> headers = {}, *ReactionsListForIssueCommentQueries queries) returns Reaction[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Reaction exists 
    resource isolated function post repos/[string owner]/[string repo]/issues/comments/[int comment_id]/reactions(CommentIdReactionsBody1 payload, map<string|string[]> headers = {}) returns Reaction|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/comments/${getEncodedUri(comment_id)}/reactions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/issues/comments/[int comment_id]/reactions/[int reaction_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/issues/[int issue_number](map<string|string[]> headers = {}) returns Issue|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/issues/[int issue_number](IssuesissueNumberBody payload, map<string|string[]> headers = {}) returns Issue|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/${getEncodedUri(issue_number)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/issues/[int issue_number]/assignees(IssueNumberAssigneesBody payload, map<string|string[]> headers = {}) returns Issue|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/issues/[int issue_number]/assignees(IssueNumberAssigneesBody1 payload, map<string|string[]> headers = {}) returns Issue|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/${getEncodedUri(issue_number)}/assignees`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function get repos/[string owner]/[string repo]/issues/[int issue_number]/assignees/[string assignee](map<string|string[]> headers = {}) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/issues/[int issue_number]/comments(map<string|string[]> headers = {}, *IssuesListCommentsQueries queries) returns IssueComment[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/issues/[int issue_number]/comments(IssueNumberCommentsBody payload, map<string|string[]> headers = {}) returns IssueComment|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/${getEncodedUri(issue_number)}/comments`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/issues/[int issue_number]/events(map<string|string[]> headers = {}, *IssuesListEventsQueries queries) returns IssueEventForIssue[]|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/issues/[int issue_number]/labels(map<string|string[]> headers = {}, *IssuesListLabelsOnIssueQueries queries) returns Label[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put repos/[string owner]/[string repo]/issues/[int issue_number]/labels(IssueNumberLabelsBody payload, map<string|string[]> headers = {}) returns Label[]|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/${getEncodedUri(issue_number)}/labels`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/issues/[int issue_number]/labels(IssueNumberLabelsBody1 payload, map<string|string[]> headers = {}) returns Label[]|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/${getEncodedUri(issue_number)}/labels`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/issues/[int issue_number]/labels(map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/${getEncodedUri(issue_number)}/labels`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/issues/[int issue_number]/labels/[string name](map<string|string[]> headers = {}) returns Label[]|error {
    ...
    resource isolated function put repos/[string owner]/[string repo]/issues/[int issue_number]/'lock(IssueNumberLockBody payload, map<string|string[]> headers = {}) returns error? {
    ...
    resource isolated function delete repos/[string owner]/[string repo]/issues/[int issue_number]/'lock(map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/${getEncodedUri(issue_number)}/lock`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/issues/[int issue_number]/reactions(map<string|string[]> headers = {}, *ReactionsListForIssueQueries queries) returns Reaction[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/issues/[int issue_number]/reactions(IssueNumberReactionsBody payload, map<string|string[]> headers = {}) returns Reaction|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/${getEncodedUri(issue_number)}/reactions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/issues/[int issue_number]/reactions/[int reaction_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/issues/[int issue_number]/timeline(map<string|string[]> headers = {}, *IssuesListEventsForTimelineQueries queries) returns TimelineIssueEvents[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/keys/[int key_id](map<string|string[]> headers = {}) returns DeployKey|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/keys/[int key_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/keys/${getEncodedUri(key_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/milestones/[int milestone_number](map<string|string[]> headers = {}) returns Milestone|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/milestones/[int milestone_number](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/milestones/${getEncodedUri(milestone_number)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/milestones/[int milestone_number](MilestonesmilestoneNumberBody payload, map<string|string[]> headers = {}) returns Milestone|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/milestones/${getEncodedUri(milestone_number)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/milestones/[int milestone_number]/labels(map<string|string[]> headers = {}, *IssuesListLabelsForMilestoneQueries queries) returns Label[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/projects(RepoProjectsBody payload, map<string|string[]> headers = {}) returns Project|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/projects`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/pulls/comments/[int comment_id](map<string|string[]> headers = {}) returns PullRequestReviewComment|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/pulls/comments/[int comment_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/comments/${getEncodedUri(comment_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/pulls/comments/[int comment_id](CommentscommentIdBody3 payload, map<string|string[]> headers = {}) returns PullRequestReviewComment|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/comments/${getEncodedUri(comment_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/pulls/comments/[int comment_id]/reactions(map<string|string[]> headers = {}, *ReactionsListForPullRequestReviewCommentQueries queries) returns Reaction[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Reaction exists 
    resource isolated function post repos/[string owner]/[string repo]/pulls/comments/[int comment_id]/reactions(CommentIdReactionsBody2 payload, map<string|string[]> headers = {}) returns Reaction|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/comments/${getEncodedUri(comment_id)}/reactions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/pulls/comments/[int comment_id]/reactions/[int reaction_id](map<string|string[]> headers = {}) returns error? {
    ...
    resource isolated function get repos/[string owner]/[string repo]/pulls/[int pull_number](map<string|string[]> headers = {}) returns PullRequest|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/pulls/[int pull_number](PullspullNumberBody payload, map<string|string[]> headers = {}) returns PullRequest|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/${getEncodedUri(pull_number)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response when the codespace was successfully created 
    resource isolated function post repos/[string owner]/[string repo]/pulls/[int pull_number]/codespaces(PullNumberCodespacesBody payload, map<string|string[]> headers = {}) returns Codespace|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/pulls/[int pull_number]/comments(map<string|string[]> headers = {}, *PullsListReviewCommentsQueries queries) returns PullRequestReviewComment[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/pulls/[int pull_number]/comments(PullNumberCommentsBody payload, map<string|string[]> headers = {}) returns PullRequestReviewComment|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/${getEncodedUri(pull_number)}/comments`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/pulls/[int pull_number]/comments/[int comment_id]/replies(CommentIdRepliesBody payload, map<string|string[]> headers = {}) returns PullRequestReviewComment|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/pulls/[int pull_number]/commits(map<string|string[]> headers = {}, *PullsListCommitsQueries queries) returns Commit[]|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/pulls/[int pull_number]/files(map<string|string[]> headers = {}, *PullsListFilesQueries queries) returns DiffEntry[]|error {
    ...
    resource isolated function get repos/[string owner]/[string repo]/pulls/[int pull_number]/merge(map<string|string[]> headers = {}) returns error? {
    ...
    resource isolated function put repos/[string owner]/[string repo]/pulls/[int pull_number]/merge(PullNumberMergeBody payload, map<string|string[]> headers = {}) returns PullRequestMergeResult|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/${getEncodedUri(pull_number)}/merge`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/pulls/[int pull_number]/requested_reviewers(map<string|string[]> headers = {}) returns PullRequestReviewRequest|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/pulls/[int pull_number]/requested_reviewers(PullNumberRequestedReviewersBody payload, map<string|string[]> headers = {}) returns PullRequestSimple|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/${getEncodedUri(pull_number)}/requested_reviewers`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/pulls/[int pull_number]/requested_reviewers(PullNumberRequestedReviewersBody1 payload, map<string|string[]> headers = {}) returns PullRequestSimple|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/${getEncodedUri(pull_number)}/requested_reviewers`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function get repos/[string owner]/[string repo]/pulls/[int pull_number]/reviews(map<string|string[]> headers = {}, *PullsListReviewsQueries queries) returns PullRequestReview[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/pulls/[int pull_number]/reviews(PullNumberReviewsBody payload, map<string|string[]> headers = {}) returns PullRequestReview|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/${getEncodedUri(pull_number)}/reviews`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/pulls/[int pull_number]/reviews/[int review_id](map<string|string[]> headers = {}) returns PullRequestReview|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put repos/[string owner]/[string repo]/pulls/[int pull_number]/reviews/[int review_id](ReviewsreviewIdBody payload, map<string|string[]> headers = {}) returns PullRequestReview|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/${getEncodedUri(pull_number)}/reviews/${getEncodedUri(review_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/pulls/[int pull_number]/reviews/[int review_id](map<string|string[]> headers = {}) returns PullRequestReview|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/pulls/${getEncodedUri(pull_number)}/reviews/${getEncodedUri(review_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/pulls/[int pull_number]/reviews/[int review_id]/comments(map<string|string[]> headers = {}, *PullsListCommentsForReviewQueries queries) returns ReviewComment[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put repos/[string owner]/[string repo]/pulls/[int pull_number]/reviews/[int review_id]/dismissals(ReviewIdDismissalsBody payload, map<string|string[]> headers = {}) returns PullRequestReview|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repos/[string owner]/[string repo]/pulls/[int pull_number]/reviews/[int review_id]/events(ReviewIdEventsBody payload, map<string|string[]> headers = {}) returns PullRequestReview|error {
    ...
    resource isolated function put repos/[string owner]/[string repo]/pulls/[int pull_number]/update\-branch(PullNumberUpdateBranchBody payload, map<string|string[]> headers = {}) returns NotificationRead|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/releases/assets/[int asset_id](map<string|string[]> headers = {}) returns ReleaseAsset|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/releases/assets/[int asset_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/releases/assets/${getEncodedUri(asset_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/releases/assets/[int asset_id](AssetsassetIdBody payload, map<string|string[]> headers = {}) returns ReleaseAsset|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/releases/assets/${getEncodedUri(asset_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function get repos/[string owner]/[string repo]/releases/[int release_id](map<string|string[]> headers = {}) returns Release|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/releases/[int release_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/releases/${getEncodedUri(release_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/releases/[int release_id](ReleasesreleaseIdBody payload, map<string|string[]> headers = {}) returns Release|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/releases/${getEncodedUri(release_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/releases/[int release_id]/assets(map<string|string[]> headers = {}, *ReposListReleaseAssetsQueries queries) returns ReleaseAsset[]|error {
    ...
    resource isolated function post repos/[string owner]/[string repo]/releases/[int release_id]/assets(byte[] payload, map<string|string[]> headers = {}, *ReposUploadReleaseAssetQueries queries) returns ReleaseAsset|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/releases/${getEncodedUri(release_id)}/assets`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/releases/[int release_id]/reactions(map<string|string[]> headers = {}, *ReactionsListForReleaseQueries queries) returns Reaction[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Reaction exists 
    resource isolated function post repos/[string owner]/[string repo]/releases/[int release_id]/reactions(ReleaseIdReactionsBody payload, map<string|string[]> headers = {}) returns Reaction|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/releases/${getEncodedUri(release_id)}/reactions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/releases/[int release_id]/reactions/[int reaction_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/rulesets/rule\-suites/[int rule_suite_id](map<string|string[]> headers = {}) returns RuleSuite|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/secret\-scanning/alerts/[AlertNumber alert_number](map<string|string[]> headers = {}) returns SecretScanningAlert|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/secret\-scanning/alerts/[AlertNumber alert_number](AlertsalertNumberBody2 payload, map<string|string[]> headers = {}) returns SecretScanningAlert|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/secret-scanning/alerts/${getEncodedUri(alert_number)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/secret\-scanning/alerts/[AlertNumber alert_number]/locations(map<string|string[]> headers = {}, *SecretScanningListLocationsForAlertQueries queries) returns SecretScanningLocation[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repos/[string owner]/[string repo]/security\-advisories/[string ghsa_id](map<string|string[]> headers = {}) returns RepositoryAdvisory|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repos/[string owner]/[string repo]/security\-advisories/[string ghsa_id](RepositoryAdvisoryUpdate payload, map<string|string[]> headers = {}) returns RepositoryAdvisory|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/security-advisories/${getEncodedUri(ghsa_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Accepted 
    resource isolated function post repos/[string owner]/[string repo]/security\-advisories/[string ghsa_id]/cve(map<string|string[]> headers = {}) returns record {}|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/tags/protection/[int tag_protection_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repositories/[int repository_id]/environments/[string environment_name]/secrets(map<string|string[]> headers = {}, *ActionsListEnvironmentSecretsQueries queries) returns ActionsSecretResponse|error {
        string resourcePath = string `/repositories/${getEncodedUri(repository_id)}/environments/${getEncodedUri(environment_name)}/secrets`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }

    resource isolated function get repositories/[int repository_id]/environments/[string environment_name]/secrets/public\-key(map<string|string[]> headers = {}) returns ActionsPublicKey|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repositories/[int repository_id]/environments/[string environment_name]/secrets/[string secret_name](map<string|string[]> headers = {}) returns ActionsSecret|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response when creating a secret 
    resource isolated function put repositories/[int repository_id]/environments/[string environment_name]/secrets/[string secret_name](SecretssecretNameBody6 payload, map<string|string[]> headers = {}) returns EmptyObject|error? {
        string resourcePath = string `/repositories/${getEncodedUri(repository_id)}/environments/${getEncodedUri(environment_name)}/secrets/${getEncodedUri(secret_name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Default response 
    resource isolated function delete repositories/[int repository_id]/environments/[string environment_name]/secrets/[string secret_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repositories/${getEncodedUri(repository_id)}/environments/${getEncodedUri(environment_name)}/secrets/${getEncodedUri(secret_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get repositories/[int repository_id]/environments/[string environment_name]/variables(map<string|string[]> headers = {}, *ActionsListEnvironmentVariablesQueries queries) returns ActionsVariableResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post repositories/[int repository_id]/environments/[string environment_name]/variables(EnvironmentNameVariablesBody payload, map<string|string[]> headers = {}) returns EmptyObject|error {
        string resourcePath = string `/repositories/${getEncodedUri(repository_id)}/environments/${getEncodedUri(environment_name)}/variables`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get repositories/[int repository_id]/environments/[string environment_name]/variables/[string name](map<string|string[]> headers = {}) returns ActionsVariable|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete repositories/[int repository_id]/environments/[string environment_name]/variables/[string name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repositories/${getEncodedUri(repository_id)}/environments/${getEncodedUri(environment_name)}/variables/${getEncodedUri(name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch repositories/[int repository_id]/environments/[string environment_name]/variables/[string name](VariablesnameBody2 payload, map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/repositories/${getEncodedUri(repository_id)}/environments/${getEncodedUri(environment_name)}/variables/${getEncodedUri(name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id](map<string|string[]> headers = {}) returns TeamFull|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function delete teams/[int team_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function patch teams/[int team_id](TeamsteamIdBody payload, map<string|string[]> headers = {}) returns TeamFull|error {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/discussions(map<string|string[]> headers = {}, *TeamsListDiscussionsLegacyQueries queries) returns TeamDiscussion[]|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function post teams/[int team_id]/discussions(TeamIdDiscussionsBody payload, map<string|string[]> headers = {}) returns TeamDiscussion|error {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/discussions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/discussions/[int discussion_number](map<string|string[]> headers = {}) returns TeamDiscussion|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function delete teams/[int team_id]/discussions/[int discussion_number](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/discussions/${getEncodedUri(discussion_number)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function patch teams/[int team_id]/discussions/[int discussion_number](DiscussionsdiscussionNumberBody1 payload, map<string|string[]> headers = {}) returns TeamDiscussion|error {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/discussions/${getEncodedUri(discussion_number)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/discussions/[int discussion_number]/comments(map<string|string[]> headers = {}, *TeamsListDiscussionCommentsLegacyQueries queries) returns TeamDiscussionComment[]|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function post teams/[int team_id]/discussions/[int discussion_number]/comments(DiscussionNumberCommentsBody1 payload, map<string|string[]> headers = {}) returns TeamDiscussionComment|error {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/discussions/${getEncodedUri(discussion_number)}/comments`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/discussions/[int discussion_number]/comments/[int comment_number](map<string|string[]> headers = {}) returns TeamDiscussionComment|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function delete teams/[int team_id]/discussions/[int discussion_number]/comments/[int comment_number](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/discussions/${getEncodedUri(discussion_number)}/comments/${getEncodedUri(comment_number)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function patch teams/[int team_id]/discussions/[int discussion_number]/comments/[int comment_number](CommentscommentNumberBody1 payload, map<string|string[]> headers = {}) returns TeamDiscussionComment|error {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/discussions/${getEncodedUri(discussion_number)}/comments/${getEncodedUri(comment_number)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/discussions/[int discussion_number]/comments/[int comment_number]/reactions(map<string|string[]> headers = {}, *ReactionsListForTeamDiscussionCommentLegacyQueries queries) returns Reaction[]|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function post teams/[int team_id]/discussions/[int discussion_number]/comments/[int comment_number]/reactions(CommentNumberReactionsBody1 payload, map<string|string[]> headers = {}) returns Reaction|error {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/discussions/${getEncodedUri(discussion_number)}/comments/${getEncodedUri(comment_number)}/reactions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/discussions/[int discussion_number]/reactions(map<string|string[]> headers = {}, *ReactionsListForTeamDiscussionLegacyQueries queries) returns Reaction[]|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function post teams/[int team_id]/discussions/[int discussion_number]/reactions(DiscussionNumberReactionsBody1 payload, map<string|string[]> headers = {}) returns Reaction|error {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/discussions/${getEncodedUri(discussion_number)}/reactions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/invitations(map<string|string[]> headers = {}, *TeamsListPendingInvitationsLegacyQueries queries) returns OrganizationInvitation[]|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/members(map<string|string[]> headers = {}, *TeamsListMembersLegacyQueries queries) returns SimpleUser[]|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/members/[string username](map<string|string[]> headers = {}) returns error? {
    ...
    # # Deprecated
    @deprecated
    resource isolated function put teams/[int team_id]/members/[string username](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/members/${getEncodedUri(username)}`;
        http:Request request = new;
        return self.clientEp->put(resourcePath, request, headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function delete teams/[int team_id]/members/[string username](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/members/${getEncodedUri(username)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/memberships/[string username](map<string|string[]> headers = {}) returns TeamMembership|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function put teams/[int team_id]/memberships/[string username](MembershipsusernameBody2 payload, map<string|string[]> headers = {}) returns TeamMembership|error {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/memberships/${getEncodedUri(username)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function delete teams/[int team_id]/memberships/[string username](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/memberships/${getEncodedUri(username)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/projects(map<string|string[]> headers = {}, *TeamsListProjectsLegacyQueries queries) returns TeamProject[]|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/projects/[int project_id](map<string|string[]> headers = {}) returns TeamProject|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function put teams/[int team_id]/projects/[int project_id](ProjectsprojectIdBody2 payload, map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/projects/${getEncodedUri(project_id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function delete teams/[int team_id]/projects/[int project_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/projects/${getEncodedUri(project_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/repos(map<string|string[]> headers = {}, *TeamsListReposLegacyQueries queries) returns MinimalRepository[]|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/repos/[string owner]/[string repo](map<string|string[]> headers = {}) returns TeamRepository|error? {
    ...
    # # Deprecated
    @deprecated
    resource isolated function put teams/[int team_id]/repos/[string owner]/[string repo](OwnerrepoBody2 payload, map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function delete teams/[int team_id]/repos/[string owner]/[string repo](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/teams/${getEncodedUri(team_id)}/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function get teams/[int team_id]/teams(map<string|string[]> headers = {}, *TeamsListChildLegacyQueries queries) returns Team[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/codespaces/secrets/[string secret_name](map<string|string[]> headers = {}) returns CodespacesSecret|error {
    ...
    resource isolated function put user/codespaces/secrets/[string secret_name](SecretssecretNameBody7 payload, map<string|string[]> headers = {}) returns EmptyObject|error? {
        string resourcePath = string `/user/codespaces/secrets/${getEncodedUri(secret_name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete user/codespaces/secrets/[string secret_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/codespaces/secrets/${getEncodedUri(secret_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/codespaces/secrets/[string secret_name]/repositories(map<string|string[]> headers = {}) returns MinimalRepositoryResponse|error {
    ...
    resource isolated function put user/codespaces/secrets/[string secret_name]/repositories(SecretNameRepositoriesBody3 payload, map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/codespaces/secrets/${getEncodedUri(secret_name)}/repositories`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - No Content when repository was added to the selected list 
    resource isolated function put user/codespaces/secrets/[string secret_name]/repositories/[int repositoryId](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/codespaces/secrets/${getEncodedUri(secret_name)}/repositories/${getEncodedUri(repositoryId)}`;
        http:Request request = new;
        return self.clientEp->put(resourcePath, request, headers);
    }
    ...
    resource isolated function delete user/codespaces/secrets/[string secret_name]/repositories/[int repositoryId](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/codespaces/secrets/${getEncodedUri(secret_name)}/repositories/${getEncodedUri(repositoryId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/codespaces/[string codespace_name](map<string|string[]> headers = {}) returns Codespace|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Accepted 
    resource isolated function delete user/codespaces/[string codespace_name](map<string|string[]> headers = {}) returns record {}|error? {
        string resourcePath = string `/user/codespaces/${getEncodedUri(codespace_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch user/codespaces/[string codespace_name](CodespacescodespaceNameBody payload, map<string|string[]> headers = {}) returns Codespace|error {
        string resourcePath = string `/user/codespaces/${getEncodedUri(codespace_name)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post user/codespaces/[string codespace_name]/exports(map<string|string[]> headers = {}) returns CodespaceExportDetails|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/codespaces/[string codespace_name]/exports/[string export_id](map<string|string[]> headers = {}) returns CodespaceExportDetails|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/codespaces/[string codespace_name]/machines(map<string|string[]> headers = {}) returns CodespaceMachineResponse|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post user/codespaces/[string codespace_name]/publish(CodespaceNamePublishBody payload, map<string|string[]> headers = {}) returns CodespaceWithFullRepository|error {
    ...
    resource isolated function post user/codespaces/[string codespace_name]/'start(map<string|string[]> headers = {}) returns Codespace|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post user/codespaces/[string codespace_name]/stop(map<string|string[]> headers = {}) returns Codespace|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/gpg_keys/[int gpg_key_id](map<string|string[]> headers = {}) returns GpgKey|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete user/gpg_keys/[int gpg_key_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/gpg_keys/${getEncodedUri(gpg_key_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    resource isolated function get user/installations/[int installation_id]/repositories(map<string|string[]> headers = {}, *AppsListInstallationReposForAuthenticatedUserQueries queries) returns RepositoryResponse|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function put user/installations/[int installation_id]/repositories/[int repository_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete user/installations/[int installation_id]/repositories/[int repository_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/installations/${getEncodedUri(installation_id)}/repositories/${getEncodedUri(repository_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/keys/[int key_id](map<string|string[]> headers = {}) returns Key|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete user/keys/[int key_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/keys/${getEncodedUri(key_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get user/migrations/[int migration_id](map<string|string[]> headers = {}, *MigrationsGetStatusForAuthenticatedUserQueries queries) returns Migration|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/migrations/[int migration_id]/archive(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete user/migrations/[int migration_id]/archive(map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/migrations/${getEncodedUri(migration_id)}/archive`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }

    resource isolated function delete user/migrations/[int migration_id]/repos/[string repo_name]/'lock(map<string|string[]> headers = {}) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get user/migrations/[int migration_id]/repositories(map<string|string[]> headers = {}, *MigrationsListReposForAuthenticatedUserQueries queries) returns MinimalRepository[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name](map<string|string[]> headers = {}) returns Package|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete user/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/packages/${getEncodedUri(package_type)}/${getEncodedUri(package_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function post user/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/restore(map<string|string[]> headers = {}, *PackagesRestorePackageForAuthenticatedUserQueries queries) returns error? {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function get user/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions(map<string|string[]> headers = {}, *PackagesGetAllPackageVersionsForPackageOwnedByAuthenticatedUserQueries queries) returns PackageVersion[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions/[int package_version_id](map<string|string[]> headers = {}) returns PackageVersion|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete user/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions/[int package_version_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/packages/${getEncodedUri(package_type)}/${getEncodedUri(package_name)}/versions/${getEncodedUri(package_version_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post user/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions/[int package_version_id]/restore(map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete user/repository_invitations/[int invitation_id](map<string|string[]> headers = {}) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function patch user/repository_invitations/[int invitation_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/repository_invitations/${getEncodedUri(invitation_id)}`;
        http:Request request = new;
        return self.clientEp->patch(resourcePath, request, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get user/ssh_signing_keys/[int ssh_signing_key_id](map<string|string[]> headers = {}) returns SshSigningKey|error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete user/ssh_signing_keys/[int ssh_signing_key_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/user/ssh_signing_keys/${getEncodedUri(ssh_signing_key_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get users/[string username]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name](map<string|string[]> headers = {}) returns Package|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete users/[string username]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/users/${getEncodedUri(username)}/packages/${getEncodedUri(package_type)}/${getEncodedUri(package_name)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Response 
    resource isolated function post users/[string username]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/restore(map<string|string[]> headers = {}, *PackagesRestorePackageForUserQueries queries) returns error? {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get users/[string username]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions(map<string|string[]> headers = {}) returns PackageVersion[]|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function get users/[string username]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions/[int package_version_id](map<string|string[]> headers = {}) returns PackageVersion|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function delete users/[string username]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions/[int package_version_id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/users/${getEncodedUri(username)}/packages/${getEncodedUri(package_type)}/${getEncodedUri(package_name)}/versions/${getEncodedUri(package_version_id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Response 
    resource isolated function post users/[string username]/packages/["npm"|"maven"|"rubygems"|"docker"|"nuget"|"container" package_type]/[string package_name]/versions/[int package_version_id]/restore(map<string|string[]> headers = {}) returns error? {
